...
interface FirestoreSubscriptionRepository {
    ...
    suspend fun saveSubscription(userId: String, subscription: Subscription, subscriptionId: String? = null): Result<Unit>
    suspend fun updateSubscription(userId: String, subscriptionId: String, subscription: Subscription): Result<Unit>
